...
import {
  View, FlatList, Text, ActivityIndicator, StatusBar,
} from 'react-native';
...
export default class SearchGames extends Component {
  ...
  state = {
    ...
    games: [
      ...
      },
      {
        ...
        created_at: 1507135523698,
        updated_at: 1530985441916,
        popularity: 7,
        version_parent: 11156,
        ...
        first_release_date: 1512518400000,
        pulse_count: 12,
        platforms: [
          48,
        ],
        ...
        screenshots: [
          {
            url: '//images.igdb.com/igdb/image/upload/t_thumb/oendl6mo8nbjhjucxdrw.jpg',
            cloudinary_id: 'oendl6mo8nbjhjucxdrw',
            width: 1000,
            height: 563,
          },
        ],
        videos: [
          {
            name: 'Trailer',
            video_id: '6Z1AGyzZbLM',
          },
        ],
        cover: {
          url: '//images.igdb.com/igdb/image/upload/t_thumb/x7bjl0efiqe3za8c9zdq.jpg',
          cloudinary_id: 'x7bjl0efiqe3za8c9zdq',
          width: 544,
          height: 600,
        },
        websites: [
          {
            category: 14,
            url: 'https://www.reddit.com/r/horizon',
          },
          {
            category: 5,
            url: 'https://twitter.com/Guerrilla',
          },
          {
            category: 3,
          ...
          {
            category: 1,
            url: 'https://www.guerrilla-games.com/play/horizon',
          },
        ],
      },
    ],
  ...
  renderTextInfos() {
    const {
      query, loading, error, games, refreshing,
    } = this.state;
    return (
      <View>
        {
        ...
        {
        (query !== '' && loading === false && games.length === 0)
          ? (
            <Text>
  ...
  searchGames = async (text) => {
    this.setState({ query: text, loading: true });
    ...
    this.debounceSearch = setTimeout(async () => {
      ...
      try {
        const { data: games } = await api.get(`/games/search/${formatted}`);
